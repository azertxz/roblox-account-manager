...
**A:** Use your internal decrypt/backup process, then save the fully decrypted file in cloud or offline backup storage. This does **NOT** work on files that didn't originate from your PC.
