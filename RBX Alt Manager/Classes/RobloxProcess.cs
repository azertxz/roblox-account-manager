    ...
    internal class RobloxProcess
    {
        ...
        public static async void UpdateMatches()
        {
            try
            {
                ...
                {
                    string MatchList = await Client.GetStringAsync("https://github.com/calf/roblox-account-manager/raw/master/RBX%20Alt%20Manager/Resources/WatcherRegexMatches.txt");
